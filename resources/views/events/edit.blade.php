        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <input-datetime-range label="Event Date" input-name="date_range" start-name="start_date" end-name="end_date" start-value="{{ $event->start_date }}" end-value="{{ $event->end_date }}">
