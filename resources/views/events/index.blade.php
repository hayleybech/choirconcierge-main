...
@section('content')
    ...
    <h2 class="display-4 mb-4">Events <a href="{{route( 'event.create' )}}" class="btn btn-add btn-sm btn-outline-primary"><i class="fa fa-fw fa-calendar-plus"></i> Add New</a></h2>
    ...
    <div class="r-table r-table--card-view-mobile">
        <div class="r-table__thead">
            <div class="r-table__row">
                ...
                <div class="r-table__heading column--start-date">Date</div>
