...
@section('page-content')
    ...
    <div class="card bg-light">
        ...
        <div class="card-body">
            ...
            <riser-stack :rows="{{$stack->rows}}" :cols="{{ $stack->columns }}" :initial-front-row-length="{{ $stack->front_row_length }}" :initial-singers="{{ $stack->singers->toJson() }}" :edit-disabled="true"></riser-stack>
