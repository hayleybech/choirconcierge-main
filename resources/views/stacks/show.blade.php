...
@section('page-content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <riser-stack :initial-rows="{{$stack->rows}}" :initial-cols="{{ $stack->columns }}" :initial-front-row-length="{{ $stack->front_row_length }}" :initial-singers="{{ $stack->singers->toJson() }}" :initial-voice-parts="{{ $voice_parts->toJson() }}" :initial-front-row-on-floor="{{ var_export($stack->front_row_on_floor, true) }}" :edit-disabled="true"></riser-stack>
