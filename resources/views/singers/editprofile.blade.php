...
@section('page-content')
	...
	{{ Form::open( [ 'route' => ['singers.profiles.update', [$singer]], 'method' => 'put' ] ) }}
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<fieldset>
						...
						<div class="form-group">
							<x-inputs.text label="Choir Membership Details" id="membership_details" name="membership_details" :value="old('membership_details', $singer->membership_details)" />
						</div>
						<div class="form-group">
