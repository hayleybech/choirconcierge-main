...
@section('page-content')
			...
			<form method="get" class="form-inline mb-0">
				...
				<div class="input-group input-group-sm mb-2 mr-2">
					<div class="btn-group" role="group" aria-label="Basic example">
						...
						<a href="{{ route('singers.index') }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Clear</a>
					</div>
				</div>
			</form>
	...
	<div class="card">
		<div class="card-tabs nav nav-tabs">
			...
			<a href="#pane-members" class="card-tab nav-link text-success" id="tab-members" data-toggle="tab"><i class="fas fa-fw fa-circle mr-2"></i>Members <span class="badge badge-light ml-1 d-none d-md-inline-block">{{ $member_singers->count() }}</span></a>
			<a href="#pane-prospects" class="card-tab nav-link text-warning" id="tab-prospects" data-toggle="tab"><i class="fas fa-fw fa-circle mr-2"></i>Prospects <span class="badge badge-light ml-1 d-none d-md-inline-block">{{ $prospect_singers->count() }}</span></a>
			<a href="#pane-archived" class="card-tab nav-link text-secondary" id="tab-archived" data-toggle="tab"><i class="fas fa-fw fa-circle mr-2"></i>Archived <span class="badge badge-light ml-1 d-none d-md-inline-block">{{ $archived_singers->count() }}</span></a>
		</div>
