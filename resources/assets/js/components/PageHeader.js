                        ...
                        {filteredActions.length > 2
                            ? (
                                <Menu as="span" className="ml-3 relative sm:hidden z-20">
                                    ...
                                    >
                                        <Menu.Items className="origin-top-right absolute right-0 mt-2 -mr-1 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-hidden">
                                            {filteredActions.map((action, key) =>
                                                key > 0 && (
                                                <Menu.Item key={key}>
                                                    {({ active }) => action.url
                            ...
                            : filteredActions.length === 2 && (
                            <Button href={filteredActions[1].url} onClick={filteredActions[1].onClick} variant={filteredActions[1].variant} className="ml-3 sm:hidden">
                                <Icon icon={filteredActions[1].icon} mr />{filteredActions[1].label}
                            </Button>
                        )
                        }
                    </div>
