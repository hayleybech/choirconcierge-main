...
const BillingNotices = ({ billing, tenantId }) => {
  ...
  if(billing.onTrial) {
    return (
      <TenantNotice variant="info" cookieId="billing" global>
  ...
  if(billing.hasExpiredTrial) {
    return (
      <TenantNotice variant="danger" cookieId="billing" global>
  ...
  if(billing.onGracePeriod) {
    return (
      <TenantNotice variant="warning" cookieId="billing" global>
