    ...
    <Switch.Group as="div" className="flex items-center justify-between">
        ...
        <Switch
            ...
            className={classNames(
                ...
                'relative inline-flex shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-purple-500'
            )}
        >
        <span
            aria-hidden="true"
