<template>
	<div
		class="modal fade"
		id="repeatingEventDeleteModal"
		tabindex="-1"
		role="dialog"
		aria-labelledby="repeatingEventDeleteModalLabel"
		aria-hidden="true"
	>
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="repeatingEventDeleteModalLabel">
						Delete repeating event <small class="text-muted">#{{ eventId }}</small>
					</h5>
				...
				<div class="modal-body">
					<fieldset class="form-group">
						<legend class="col-form-label">
							The event "{{ eventTitle }}" is a repeating event. What do you want to delete?
						</legend>
							...
							>
								...
								<span>
									...
									<span class="form-text text-danger" v-if="eventInPast"
										...
										bulk delete past events. Please delete individually instead.</span
									>
								</span>
							</label>
