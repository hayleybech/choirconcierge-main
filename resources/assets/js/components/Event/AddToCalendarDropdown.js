...
const AddToCalendarDropdown = ({ urls, size = 'sm' }) => {
    let items = [
    ...
    return items.length > 0 && (
        <Menu as="div" className="relative overflow-visible flex justify-stretch md:justify-start">
            ...
            >
                <Menu.Items className="origin-top-right absolute left-0 mt-2 -mr-1 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black/5 focus:outline-none">
