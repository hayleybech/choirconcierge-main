...
const RsvpDropdown = ({ event, size = 'sm' }) => {
  ...
  return items.length > 0 && (
    <Menu as="div" className="relative inline-block w-full sm:w-auto overflow-visible">
      ...
      >
        <Menu.Items
          className="origin-top-right absolute z-10 left-0 mt-2 -mr-1 min-w-full md:min-w-0 md:w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black/5 focus:outline-none">
