									...
									<li key={attendance.member.id} className="bg-white">
										<div className="relative px-6 py-5 flex flex-col xl:flex-row items-stretch xl:items-center gap-y-3 sm:gap-x-3 hover:bg-gray-50 justify-between">
											<div className="flex space-x-2 shrink-0">
												...
												<div className="flex-1 min-w-0">
													...
													<p className="text-sm">
														...
														{attendance.response.includes('absent') &&
															attendance.absent_reason && (
																<div className="text-gray-500">
																	Reason for absence: {attendance.absent_reason}
																</div>
															)}
													</p>
												</div>
											...
											<div className="shrink-0 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 items:stretch sm:items-end">
												...
												{!['absent', 'absent_apology'].includes(
													attendance.response
												) && (
													<>
														...
														<Button
															...
															method="put"
															data={{
																response: !!absentReasons[attendance.member.id]
																	? 'absent_apology'
																	: 'absent',
																absent_reason: absentReasons[attendance.member.id],
															}}
