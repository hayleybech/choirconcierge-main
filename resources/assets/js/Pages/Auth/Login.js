...
const Login = ({ tenant, toastErrors, flash, isWebView }) => {
				...
				<div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
					...
					{!isWebView && (
						<div className="text-center mt-6">
							...
							&nbsp;
							<a href={route('register')} className="font-medium text-purple-600 hover:text-purple-500">
								Start a 30-day free trial
							</a>
							&nbsp;or&nbsp;
							<a
								href="https://www.choirconcierge.com"
								className="font-medium text-purple-600 hover:text-purple-500"
							>
								Contact Us
							</a>
