...
const TenantStatsWidget = ({activeTenants, tenantsOnTrial, tenantsTrialExpired, activeMembers, trialConversionRate, medianRetentionTime}) => (
	<Panel noPadding>
		...
		<dl className="mx-auto grid grid-cols-1 gap-px sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 border-t border-gray-100">
			...
			<div
				...
				<dd className="w-full flex-none text-3xl font-medium leading-10 tracking-tight text-gray-900">{medianRetentionTime} months</dd>
