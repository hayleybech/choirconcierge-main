	...
	<>
		...
		<div className="py-6">
			<div className="mx-auto px-4 sm:px-6 lg:px-16">
				<div className="mb-8">
					<h1 className="text-2xl font-semibold text-gray-900 mb-2"><Icon icon="code-merge" mr /> Changelog</h1>
				</div>
							...
							<li key={date} className="relative flex gap-x-4">
								...
								<div className="flex-auto">
									...
									<div
										...
										className="text-gray-500 text-sm [&>p]:mb-2 [&>ul]:ml-5 [&>ul]:list-disc [&_li]:mb-1"
									/>
								</div>
