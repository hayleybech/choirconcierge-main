/******/ (function(modules) {
  ...
  \**********************************************/
			...
			/***/ function(module, exports, __webpack_require__) {
				...
				class Risers {
					constructor(selector, height, width) {
						...
						__classPrivateFieldSet(this, _origin, {
							x:
								__classPrivateFieldGet(this, _canvas_width) *
								__classPrivateFieldGet(this, _origin_modifier).x,
							y:
								__classPrivateFieldGet(this, _canvas_height) *
								__classPrivateFieldGet(this, _origin_modifier).y,
						});
						__classPrivateFieldSet(
							this,
							_edges,
							new Array(__classPrivateFieldGet(this, _num_cols) + 1).fill(null).map(() => ({
								start: null,
								end: null,
							}))
						);
					...
					drawEdges() {
						for (let i = 0; i <= __classPrivateFieldGet(this, _num_cols); i++) {
							...
							const line = __classPrivateFieldGet(this, _snap).line(
								edge.start.x,
								edge.start.y,
								edge.end.x,
								edge.end.y
					...
					createArc(row, col) {
						...
						const row_start_radius =
							__classPrivateFieldGet(this, _risers_start_radius) +
							row * __classPrivateFieldGet(this, _row_height_radius);
						// Start angle for current arc
						const col_start_angle =
							__classPrivateFieldGet(this, _risers_start_angle) +
							__classPrivateFieldGet(this, _col_width_deg) * col;
						const col_end_angle = col_start_angle + __classPrivateFieldGet(this, _col_width_deg);
						// Create the arc
						return new Arc(
							__classPrivateFieldGet(this, _origin).x,
							__classPrivateFieldGet(this, _origin).y,
							row_start_radius,
							col_start_angle,
							col_end_angle
						);
					...
					calcSizes() {
						...
						__classPrivateFieldSet(
							this,
							_risers_start_radius,
							__classPrivateFieldGet(this, _canvas_height) * 1.05
						);
						__classPrivateFieldSet(
							this,
							_risers_end_radius,
							__classPrivateFieldGet(this, _canvas_height) * 0.4
						);
						// Distance (radius) between rows
						__classPrivateFieldSet(
							this,
							_row_height_radius,
							__classPrivateFieldGet(this, _risers_end_radius) / __classPrivateFieldGet(this, _num_rows)
						);
						// Start angle for cols
						__classPrivateFieldSet(
							this,
							_risers_start_angle,
							0 - __classPrivateFieldGet(this, _total_width_deg) / 2
						);
						__classPrivateFieldSet(
							this,
							_col_width_deg,
							__classPrivateFieldGet(this, _total_width_deg) / __classPrivateFieldGet(this, _num_cols)
						);
					}
				...
				(_snap = new WeakMap()),
					(_canvas_height = new WeakMap()),
					(_canvas_width = new WeakMap()),
					(_origin = new WeakMap()),
					(_origin_modifier = new WeakMap()),
					(_total_width_deg = new WeakMap()),
					(_num_rows = new WeakMap()),
					(_num_cols = new WeakMap()),
					(_risers_start_radius = new WeakMap()),
					(_risers_end_radius = new WeakMap()),
					(_risers_start_angle = new WeakMap()),
					(_row_height_radius = new WeakMap()),
					(_col_width_deg = new WeakMap()),
					(_style = new WeakMap()),
					(_edges = new WeakMap());
  ...
  \****************************************************/
			...
			/***/ function(module, exports, __webpack_require__) {
				module.exports = __webpack_require__(
					/*! /home/vagrant/choirconcierge/resources/assets/js/risers/risers.ts */ './resources/assets/js/risers/risers.ts'
				);
