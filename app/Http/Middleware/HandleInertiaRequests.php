    ...
    public function share(Request $request)
    {
        return array_merge(parent::share($request), [
            ...
            'can' => [
                ...
                'delete_singer' => auth()->user()?->can('delete', Membership::class),
                ...
                'update_song' => auth()->user()?->can('update', Song::class),
                'delete_song' => auth()->user()?->can('delete', Song::class),
                ...
                'update_stack' => auth()->user()?->can('update', RiserStack::class),
                ...
                'delete_poll' => auth()->user()?->can('delete', Poll::class),
